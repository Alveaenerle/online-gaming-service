      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-[#1a1a27] to-[#0d0c12] rounded-2xl p-8 max-w-md mx-4 border border-red-500/30 shadow-2xl shadow-red-500/20"
          >
            {/* Warning Icon */}
            ...
            <div className="flex flex-col gap-3">
              <motion.button
                ...
                className="w-full py-3 rounded-xl bg-gradient-to-r from-purpleStart to-purpleEnd text-white font-bold shadow-lg shadow-purpleEnd/30 hover:shadow-purpleEnd/50 transition-shadow"
              >
                Return to Lobby
              </motion.button>
            </div>
