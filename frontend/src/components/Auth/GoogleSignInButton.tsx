...
const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({
  ...
  const buttonText = text === "signin" ? "Continue with Google" : "Sign up with Google";
  ...
  return (
    <div className="relative w-full">
      ...
      <motion.button
        ...
        className="w-full py-3 px-4 rounded-xl bg-[#1a1a27] border border-white/10 text-white font-semibold 
                   hover:bg-[#1f1f2e] hover:border-white/20 transition-all duration-200
